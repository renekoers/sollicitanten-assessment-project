...
export class Home extends Component {
	...
	onReceiveUpdateJson(updateJson) {
		...
		let puzzleFinalState =
			puzzleStateUpdate.states[puzzleStateUpdate.states.length - 1];
		...
		return (
			<div>
				<div style={{ width: "300px" }}>
					<LevelGrid
						puzzle={this.state.puzzleState}
						isComplete={this.state.puzzleCompleted}
					/>
				</div>
				<hr />
				<div style={{ width: "300px" }}>
					<LevelGrid
						puzzle={JSON.parse(Home.puzzle2InitialJSON)}
						isComplete={false}
					/>
				</div>
