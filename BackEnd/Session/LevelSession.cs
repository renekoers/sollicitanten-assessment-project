...
namespace BackEnd
{
    public class LevelSession : Session
    {
        ...
        public static int GetLines(LevelSolution solution)
        {
        ...
        public static Func<LevelSolution,int> GetAttempts(LevelSession session) => (solution => session.Solutions.IndexOf(solution));
    }
}
